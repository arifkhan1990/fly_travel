<nav class="side-nav">
    <a href="" class="intro-x flex items-center pl-5 pt-4">
        ...
        <span class="hidden xl:block text-white text-lg ml-3"> Fly<span class="font-medium">Travel</span> </span>
    </a>
    ...
    <ul>
        ...
        <li>
            <a href="javascript:;" class="side-menu">
                ...
                <div class="side-menu__title"> Administrator <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
            </a>
            <ul class="">
                <li>
                    <a href="{{route('allEmployee')}}" class="side-menu">
        ...
        <li>
            <a href="side-menu-light-point-of-sale.html" class="side-menu">
                ...
                <div class="side-menu__title"> Shop </div>
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="javascript:;" class="side-menu">
                ...
                <div class="side-menu__title"> Services <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
            </a>
            <ul class="">
                <li>
                    <a href="side-menu-light-crud-data-list.html" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="side-menu__title"> Hotel </div>
                    </a>
                </li>
                <li>
                    <a href="side-menu-light-crud-form.html" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="side-menu__title"> Visa </div>
                    </a>
                </li>
                <li>
                    <a href="side-menu-light-crud-form.html" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="side-menu__title"> Air Ticket </div>
                    </a>
                </li>
            </ul>
        </li>
