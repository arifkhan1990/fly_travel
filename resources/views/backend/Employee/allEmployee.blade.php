...
@section('main_content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <button class="button text-white bg-theme-1 shadow-md mr-2">Add New Employee</button>
            <div class="dropdown">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tr>
                    ...
                    <th class="text-center whitespace-no-wrap">Role Name</th>
                    <th class="text-center whitespace-no-wrap">Designation</th>
                    <th class="text-center whitespace-no-wrap">Joining Date</th>
                    <th class="text-center whitespace-no-wrap">Ending Date</th>
