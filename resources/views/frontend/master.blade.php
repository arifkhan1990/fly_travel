...
<html lang="en" class="light">
    ...
    <!-- END: Head -->
    <body class="app bg-indigo-500">
        <!-- BEGIN: Mobile Menu -->
        <div class="mobile-menu md:hidden">
            <div class="mobile-menu-bar">
                <a href="" class="flex mr-auto">
                    <img style="width: 60px; height: 60px;" alt="Fly Travel" class="w-6" src="{{asset('assets/admin/dist/logo/travel-fly-logo.jpeg')}}">
                </a>
        ...
        <div class="border-b border-theme-24 -mt-10 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 pt-3 md:pt-0 mb-2">
            <div class="top-bar-boxed flex items-center">
                ...
                <a href="" class="-intro-x hidden md:flex">
                    ...
                    <span class="font-serif text-white text-lg ml-3">FLY <span class="font-medium" style="">Travel</span> </span>
                </a>
                <!-- END: Logo -->
                <!-- BEGIN: Breadcrumb -->
                <div class="-intro-x breadcrumb breadcrumb--light mr-auto"> 
                  <div class="top-menu__icon"> <i data-feather="mail"> </i>
                  </div> 
                    <a href="" style="margin-left:2px;margin-right:2px;" class="text-orange-300 breadcrumb--"> agamirit.solutions@bd.com </a> 
                  <div class="top-menu__icon"> <i data-feather="phone" class="dark:text-gray-300"></i>  
                    <a href="" class="breadcrumb--active">
                  </div>  +8801869-258594</a> 
                </div>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Search -->
                <div class="intro-x relative mr-3 sm:mr-6">
                    ...
                    <div class="search-result">
                        <div class="search-result__content">
                            ...
                            <div class="mb-5">
                                <a href="" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/profile-1.jpg')}}">
                                    </div>
                                ...
                                <a href="" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/preview-5.jpg')}}">
                                    </div>
                                ...
                                <a href="" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/preview-6.jpg')}}">
                                    </div>
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/preview-7.jpg')}}">
                                </div>
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/preview-8.jpg')}}">
                                </div>
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 image-fit">
                                    <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/preview-1.jpg')}}">
                                </div>
                                <div class="ml-3">Sony A7 III</div>
                                <div class="ml-auto w-48 truncate text-gray-600 text-xs text-right">Photography</div>
                            </a>
                ...
                <div class="intro-x dropdown mr-4 sm:mr-6">
                    ...
                    <div class="notification-content pt-2 dropdown-box">
                        <div class="notification-content__box dropdown-box__content box dark:bg-dark-6">
                            ...
                            <div class="cursor-pointer relative flex items-center mt-5">
                                <div class="w-12 h-12 flex-none image-fit mr-1">
                                    <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/profile-2.jpg')}}">
                                    <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                </div>
                                <div class="ml-2 overflow-hidden">
                                    <div class="flex items-center">
                            ...
                            <div class="cursor-pointer relative flex items-center mt-5">
                                <div class="w-12 h-12 flex-none image-fit mr-1">
                                    <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/profile-6.jpg')}}">
                                    <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                </div>
                                <div class="ml-2 overflow-hidden">
                                    <div class="flex items-center">
                            ...
                            <div class="cursor-pointer relative flex items-center mt-5">
                                <div class="w-12 h-12 flex-none image-fit mr-1">
                                    <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/profile-3.jpg')}}">
                                    <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                </div>
                                <div class="ml-2 overflow-hidden">
                                    <div class="flex items-center">
                ...
                <div class="intro-x dropdown w-8 h-8">
                    <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110">
                        <img alt="img_profile" class="rounded-full" src="{{asset('assets/admin/dist/images/profile-11.jpg')}}">
                    </div>
...
<!--         <div data-url="top-menu-dark-dashboard.html" class="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 right-0 box dark:bg-dark-2 border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-10 mr-10">
        ...
        <!-- BEGIN: JS Assets-->
          ...
          @include('frontend.layouts.custom_js')
      </body>
        <!-- END: JS Assets-->
